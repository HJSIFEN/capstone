...
def get_data(keywords = ['축구'], client_id = "mFVJrDtj4trdT2ermoVF", client_secret = "hbpIY84KD3", naver_api = False, length = 1000):
    data = []
    text_list = []
    for keyword in keywords:
        ...
        data_dict['past_date'] = make_past_day(data_dict)
        data_dict['five_day_visitor'] = five_day_visitor
        data_dict['label'] = range(len(text_amount))
        data += [data_dict]
        text_list += text1
